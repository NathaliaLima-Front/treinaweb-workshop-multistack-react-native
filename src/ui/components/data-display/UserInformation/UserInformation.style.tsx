...
/*
    * Quando o typescript não reconhece algo e indica o erro, mesmo não tendo no cado de starContainerStyle: css``
        pode-se ignorar o mesmo, colocando //@ts-ignore acima da linha onde indica o problema
*/
